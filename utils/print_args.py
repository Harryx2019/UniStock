def print_args(args):
    ...
    print(f'  {"Data Path:":<20}{args.data_path:<20}{"Market Name:":<20}{args.market_name:<20}{"Features:":<20}{args.features:<20}')
    print(f'  {"Target:":<20}{args.target:<20}{"Freq:":<20}{args.freq:<20}')
    print(f'  {"Embed:":<20}{args.embed:<20}{"Stride:":<20}{args.stride_dataset:<20}')
    print()
    
    if args.task_name in ['pretrain', 'finetune', 'zeroshot', 'supervised']:
        print("\033[1m" + "Stock Task" + "\033[0m")
        print(f'  {"Token Num:":<20}{args.token_num:<20}{"Input Token Len:":<20}{args.input_token_len:<20}{"Output Token Len:":<20}{args.output_token_len:<20}')
        print(f'  {"Seq Len:":<20}{args.seq_len:<20}{"Label Len:":<20}{args.label_len:<20}')
        print(f'  {"Pred Len:":<20}{args.pred_len:<20}{"Output Len:":<20}{args.output_len:<20}')
        print(f'  {"Scale:":<20}{args.scale:<20}{"Inverse:":<20}{args.inverse:<20}{"Quantile:":<20}{args.quantile:<20}')
        print(f'  {"Train Begin Date:":<20}{args.train_begin_date:<20}{"Valid Begin Date:":<20}{args.valid_begin_date:<20}{"Test Begin Date:":<20}{args.test_begin_date:<20}{"Test End Date:":<20}{args.test_end_date:<20}')
        print()
    ...
    print(f'  {"Graph:":<20}{args.graph:<20}{"Num_hyperedges:":<20}{args.num_hyperedges:<20}{"Hyperedges_quantile:":<20}{args.hyperedges_quantile:<20}')
